        ...
        <div className="profile-feilds">
          <form onSubmit={handleSubmit} className="profile-form">
            ...
            <div className="profile-feild">
              ...
              <input type="text" id="Country" name="Country" placeholder="Country" required onChange={(e) => setLocation(e.target.value)} value={location}/>
            </div>
            <button type="submit" className="profile-submit small-button" >Confirm</button>
          </form>
          <button className='small-button'>
            <Link to="/favorites" className="profile-link">Go to Favorites</Link>
          </button>
        </div>
